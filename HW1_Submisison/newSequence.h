...
//********GLOBALS USED WITH SEQUENCE CLASS*************
...
class Sequence
{
  ...
  private:
    ItemType *sequence;//a pointer to the begining of a sequence of whatever ItemType is defined to be
  ...
  public:
    ...
    ~Sequence();
    Sequence(int);//Creates an empty sequence of a user specified length
    Sequence(Sequence&); //copy constructor
    Sequence& operator=(const Sequence&); //overload operator
